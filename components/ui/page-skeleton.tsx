...
export function DashboardPageSkeleton() {
  return (
    <div className="mx-auto max-w-7xl px-5 sm:px-8 py-10 sm:py-14 animate-pulse">
      <div className="h-44 rounded-[calc(var(--radius-card)+0.125rem)] bg-[var(--color-surface-secondary)] border border-[var(--color-border)] shadow-[var(--shadow-md)] mb-10" />
...
export function ContactsListSkeleton() {
  return (
    <div className="mx-auto max-w-7xl px-5 sm:px-8 py-10 sm:py-14 animate-pulse">
      <div className="h-36 rounded-[calc(var(--radius-card)+0.125rem)] bg-[var(--color-surface-secondary)] border border-[var(--color-border)] shadow-[var(--shadow-md)] mb-8" />
