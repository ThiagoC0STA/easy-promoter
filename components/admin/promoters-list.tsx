...
export function PromotersList({ promoters, currentUserId }: Props) {
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className="text-sm font-medium text-[var(--color-text-primary)] truncate flex items-center gap-2">
                  ...
                  {isMe && (
                    <span className="shrink-0 inline-flex items-center px-1.5 py-0.5 rounded-md text-[10px] font-semibold uppercase tracking-wide bg-[var(--color-accent-muted)] text-[var(--color-accent)]">
                      Você
                    </span>
                  )}
                </p>
